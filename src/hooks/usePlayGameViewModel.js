...
export function usePlayGameViewModel() {
  ...
  }, [hasLoadedProgress, journey.stage, journey.target, allProgress, currentLetter, isPracticeMode, isReviewMode, requestedReviewLetter]);
  ...
  }, [hasLoadedProgress, isGuidedMission, journey]);
...
- "recognized_as": the letter/shape you see`,
  ...
  }, [currentLetter, isPracticeMode, saveMutation]);
  ...
  }, [currentLetter, allProgress, isDailyMode, isReviewMode, continueReviewSession]);
