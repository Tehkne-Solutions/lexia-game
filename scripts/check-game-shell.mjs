...
assert.ok(playGame.includes('game-safe-top'));
...
console.log('Lexia Game Shell M07-G contract: PASS (100dvh, safe areas, bounded scrolling, responsive drawing surface)');
